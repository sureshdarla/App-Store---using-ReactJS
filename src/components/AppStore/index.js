...
class AppStore extends Component {
  ...
  onclickChangeTabId = id => {
    console.log('yes its is clicked and i am fdo')
  ...
  render() {
    ...
    // const {tabId} = tabItem
    console.log('in appstore', tabId)

    const appItems = appsList.filter(eachApp => eachApp.category === tabId)
    console.log(appItems)

    const searchResult = appItems.filter(each =>
